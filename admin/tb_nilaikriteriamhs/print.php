    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Laporan Rekomendasi</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Berikut merupakan Hasil Rekomendasi UKT Mahasiswa</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body ">
          <div class="row mb-2">
