                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <center>ID SubKriteria</center>
                                </th>
                                <th>
                                    <center>Nilai Mahasiswa</center>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                                    ...
                                    <td>
                                        <div class="w3-dropdown-hover">
                                            ...
                                            <div class="w3-dropdown-content w3-bar-block w3-card-4">
                                                <center>
                                                    <a href='hapus_nilaikriteriamhs.php?id_nilai=<?php echo $row['id_nilai'];  ?>' class="btn btn-danger"> <i class="fas fa-trash"></i>
                                                        Hapus
                                                    </a>
                                                </center>
                                            </div>
