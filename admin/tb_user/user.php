                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST" action="update_user.php">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="username" type="text" class="form-control" id="username" placeholder="" value="<?php echo $row['username']; ?>" readonly />
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label>Password</label>
                                                                        <input name="pw" type="password" class="form-control" id="pw" placeholder="pw" value="<?php echo $row['pw']; ?>" required />
                                                                    </div>
