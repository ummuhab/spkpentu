                    ...
                    <div class="w3-dropdown-hover">
                      ...
                      <div class="w3-dropdown-content w3-bar-block w3-card-4">
                              ...
                              <div class="modal-body">
                                <form method="POST" action="update_levelukt.php">
                                  <div class="form-group">
                                    ...
                                    <input name="id_level" type="text" class="form-control" id="id_level" placeholder="" value="<?php echo $row['id_level']; ?>" readonly />
                                  </div>
                                  ...
                                  <div class="form-group">
                                    <label for="rentang_level">Rentang Level</label>
                                    <input name="rentang_level" type="text" class="form-control" id="rentang_level" placeholder="rentang_level" value="<?php echo $row['rentang_level']; ?>" required />
                                  </div>
                              </div>
                        ...
                        <center> <a data-toggle="modal" data-target="#modal-edit<?php echo $row['id_level']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i>Edit
                          ...
                          <a href='hapus_levelukt.php?id_level=<?php echo $row['id_level'];  ?>' class="btn btn-danger"> <i class="fas fa-trash"></i>
                            Hapus
                          </a>
                        </center>
                      </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="input_levelukt.php">
              ...
              <div class="form-group">
                <label>Nama Level</label>
                <input value="Golongan" name="nama_level" type="text" class="form-control" id="nama_level" required />
              </div>

              <div class="form-group">
                <label for="rentang_level">Rentang Level</label>
                <input name="rentang_level" type="text" class="form-control" id="rentang_level" required />
              </div>
              <!-- </div> -->
