...
function edit($data)
{
    ...
    $query = "UPDATE tb_subkriteria set id_subkriteria='$id_subkriteria', nama_subkriteria='$nama_subkriteria', id_kriteria='$id_kriteria', nilai_kriteria='$nilai_kriteria' WHERE id_subkriteria='$id_subkriteria'";
