        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-12 col-md-6 text-right">
              <a href="import.php" class="btn btn-warning "><i class="fas fa-plus"></i><span> Import</span></a>
              <a href="tambah_mahasiswa.php" class="btn btn-success "><i class="fas fa-plus"></i><span> Tambah</span></a>
            </div>
          </div>
          <br></br>
                  ...
                  <td>
                    <div class="w3-dropdown-hover">
                      ...
                      <div class="w3-dropdown-content w3-bar-block w3-card-4">
                        <center>
                          <a href='edit_mahasiswa.php?edit=<?php echo $row['id_mhs'];  ?>' class="btn btn-primary"> <i class="fas fa-pencil"></i>
                            Edit
                          </a>
                          <a onclick="return confirm('Apakah kamu yakin ingin menghapus data?')" href='hapus_mahasiswa.php?id_mhs=<?php echo $row['id_mhs'];  ?>' class="btn btn-danger"> <i class="fas fa-trash"></i>
                            Hapus
                          </a>
                        </center>
