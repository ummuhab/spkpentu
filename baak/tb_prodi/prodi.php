                                        ...
                                        <div class="w3-dropdown-hover">
                                            ...
                                            <div class="w3-dropdown-content w3-bar-block w3-card-4">
                                                ...
                                                <center> <a data-toggle="modal" data-target="#modal-edit<?php echo $row['id_prodi']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i>Edit
                                                    ...
                                                    <a onclick="return confirm('Apakah kamu yakin ingin menghapus data?')" href='hapus_prodi.php?id_prodi=<?php echo $row['id_prodi'];  ?>' class="btn btn-danger"> <i class="fas fa-trash"></i>
                                                        Hapus
                                                    </a>
                                                </center>
                                            </div>
