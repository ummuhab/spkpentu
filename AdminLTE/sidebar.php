...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index3.html" class="brand-link">
    <img src="../../AdminLTE/dist/img/spkukt2.jpg" class="brand-image img-circle" style="opacity: .8">
    <span class="brand-text font-weight-bold">SPKUKT</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="image">
        <img src="../../AdminLTE/dist/img/logo_pnc.png" class="img-circle" alt="User Image">
      </div>
